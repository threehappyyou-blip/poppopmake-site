...
(function () {
  var COMMANDS = [
    ...
    { title: 'Screenshot Markup', desc: 'Arrows, shapes, pen, highlighter, text, crop, mosaic', href: '/screenshot-markup.html', kw: 'screenshot markup annotate arrow shape pen highlighter text crop draw blur mosaic standalone' },
    { title: 'Document & Image Tools', desc: 'Merge, split PDFs · redact · extract text · face mosaic · enhance quality · AI eraser · markup', href: '/document-tools.html', kw: 'pdf merge split convert image jpg png background remove document metadata author producer clean kdp manuscript compress webp resize redact black out hide sensitive id number rrn 주민번호 ocr extract text tesseract scan face mosaic blur pixelate anonymize upscale enhance sharpen resolution eraser remove object inpaint lama screenshot markup annotate arrow shape pen highlighter text crop draw' },
    ...
    { title: 'Career Tools', desc: 'Resume builder · ATS score checker · cover letter · hourly/salary converter', href: '/career-tools.html', kw: 'resume cv job ats career keyword cover letter application hourly salary wage annual' },
    ...
    { title: 'Your Real AU Marginal Rate Explained', desc: 'LITO taper and Medicare shade-in push your real rate higher', href: '/au-marginal-rate-explained.html', kw: 'australia marginal rate lito medicare levy guide' },
    { title: 'Capital Gains Stacking Explained', desc: 'Same $50k gain, 7% or 17% tax depending on your other income', href: '/capital-gains-stacking-explained.html', kw: 'capital gains stacking niit guide tax' },
    { title: '401(k) Super Catch-Up Explained', desc: 'The 60-63 window worth up to $13,000 extra contribution room', href: '/401k-super-catchup-explained.html', kw: '401k catch-up retirement secure 2.0 guide age 60' },
    { title: 'Compare Take-Home: Worked Example', desc: 'Same salary, three countries, three very different paychecks', href: '/compare-worked-example.html', kw: 'compare salary worked example texas ontario england guide' },
    ...
    { title: 'Developer Tools', desc: 'JSON formatter, Base64, UUID, color, URL encode, dummy data', href: '/devtools.html', kw: 'json base64 uuid color hex rgb hsl developer formatter validator url encode decode dummy fake test data csv' },
