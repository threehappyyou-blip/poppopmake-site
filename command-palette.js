...
(function () {
  var COMMANDS = [
    ...
    { title: 'Document & Image Tools', desc: 'Merge, split PDFs · redact · extract text · face mosaic · enhance quality · AI eraser', href: '/document-tools.html', kw: 'pdf merge split convert image jpg png background remove document metadata author producer clean kdp manuscript compress webp resize redact black out hide sensitive id number rrn 주민번호 ocr extract text tesseract scan face mosaic blur pixelate anonymize upscale enhance sharpen resolution eraser remove object inpaint lama' },
